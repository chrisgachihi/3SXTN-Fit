...
class DrillsAdapter(var context: Context, var data:ArrayList<Drills>):BaseAdapter() {
    private class ViewHolder(row:View?){
        ...
        var tvDrill:TextView
        init {
            this.tvTitle = row?.findViewById(R.id.mTvTitle) as TextView
            this.tvDrill = row?.findViewById(R.id.mTvDrill) as TextView
        }
    }
    override fun getView(position: Int, convertView: View?, parent: ViewGroup?): View {
        ...
        viewHolder.tvDrill.text = item.drill
        return view as View
    }
